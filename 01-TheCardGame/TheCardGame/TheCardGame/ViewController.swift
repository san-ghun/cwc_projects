...
class ViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    // indicate which card the user have selected
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        // Check if there is any time remaining. Don't le the user interact if the time is 0
        if milliseconds <= 0 {
            return 
        }
        ...
        if cell?.card?.isFlipped == false && cell?.card?.isMatched == false {
            ...
            // Check if this is the first card that was flipped or the second
    ...
    func checkForMatch(_ secondFlippedCardIndex: IndexPath) {
        ...
        if cardOne.imageName == cardTwo.imageName {
            ...
            cardOneCell?.removeCardCell()
            cardTwoCell?.removeCardCell()
    ...
    func checkForGameEnd() {
        ...
        // Check if there's any card that is unmathced
        ...
        if hasWon == true {
            ...
            if milliseconds <= 0 {
                showAlert(title: "Game Over", message: "Time's Up!\nSorry, better luck next time!")
            }
    ...
    func showAlert(title: String, message: String) {
        ...
        // Add a button for the ruser to dismiss alert
